...
public class SoloWidgetTest {


    public TvPageSoloWidget mView;
    ...
    @Rule
    public ActivityTestRule<TvPageSoloWidgetActivity> mActivityRule = new ActivityTestRule<>(
            TvPageSoloWidgetActivity.class);
...
//        Set Product Image Over Lay
    ...
    public void setItemsTextStyle() {
        mView.setItemsTextColor(mActivityRule.getActivity().getResources().getColor(R.color.price_text_color));
