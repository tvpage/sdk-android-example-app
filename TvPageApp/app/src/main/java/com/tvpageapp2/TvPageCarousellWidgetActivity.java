...
public class TvPageCarousellWidgetActivity extends AppCompatActivity {

    TvPageCarouselVideoWidget tvPageLatestVideo;
...
//        widget.setTitleTextString("ABC");
//        widget.setTitleTextGravity(Enums.GRAVITY.CENTER);
    }

    void initComponents() {
        tvPageLatestVideo = (TvPageCarouselVideoWidget) getSupportFragmentManager()
...
//        tvPageLatestVideo.setAutoVideoNext(false);
...
//        tvPageLatestVideo.setModalShadowVisibility(Enums.VISIBILITY.VISIBLE);
...
//        tvPageLatestVideo.setItemsTextTypeFace("fonts/Dosis-Bold.ttf");
    ...
    public TvPageCarouselVideoWidget getWidget() {
        return (TvPageCarouselVideoWidget) getSupportFragmentManager()
                .findFragmentById(R.id.tvPageLatestVideoCarousel);
    }
