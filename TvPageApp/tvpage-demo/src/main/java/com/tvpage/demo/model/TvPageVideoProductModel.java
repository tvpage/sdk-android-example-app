...
public class TvPageVideoProductModel {
    ...
    public String getEntityIdChild() {
        return entityIdChild;
    }

    public void setEntityIdChild(String entityIdChild) {
        this.entityIdChild = entityIdChild;
    }
